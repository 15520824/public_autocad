...
(function () {
    ...
    DragZoom.prototype.onMouseUp_ = function (e) {
        ...
        if (this.dragging_) {
            ...
            */
            ...
            //function callback select polygon
            this.functionSelect_(bnds);
    ...
    */
    ...
    google.maps.Map.prototype.enableKeyDragZoom = function (functionSelect,opt_zoomOpts) {
        this.dragZoom_ = new DragZoom(this, opt_zoomOpts);
        this.dragZoom_.functionSelect_ = functionSelect;
    };
    /**
    * Disable drag zoom.
    */
...
  return wkt;
 };
google.maps.Polygon.prototype.toActive = function(parent)
{
    parent.editPolygon = this;
    this.setOptions({strokeColor:"#eb4034",fillColor:"#c18986",draggable:true,geodesic: true,editable:true});
}

google.maps.Polygon.prototype.toInActive = function(parent)
{
    parent.editPolygon = undefined;
    this.setOptions({strokeColor:"#000000",fillColor:"#adaeaf",editable:false,draggable:false,geodesic: false});
}
google.maps.Polygon.prototype.boundary = function() {
    var max = {lat:-90,lng:-200},min = {lat:90,lng:200};
    var boundary = {max:max,min:min}
    for (var i = 0; i < this.getPath().getLength(); i++) {
        var line = this.getPath().getAt(i).toJSON();
        if(max.lat<line.lat)
            max.lat=line.lat;
        if(min.lat>line.lat)
            min.lat=line.lat;
